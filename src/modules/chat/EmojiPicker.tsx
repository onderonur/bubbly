...
import usePopper from '@src/modules/shared/usePopper';
import { Maybe } from '@shared/SharedTypes';
import { isNullOrUndefined } from '@src/modules/shared/SharedUtils';
import styled from 'styled-components';

const StyledPopper = styled(Popper)`
  // If we don't use this, ChatImagePreview will be in front of
  // EmojiPicker's Popper.
